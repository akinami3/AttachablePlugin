...
def generate_launch_description() -> LaunchDescription:
    ...
    # set the world path
    gz_world_file_path = os.path.join(attachable_demos_pkg, 'world', 'arm_robot_demo.world')
